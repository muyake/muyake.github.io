...
//游戏所有元素的sprite
var CharacterImagePainter = function CharacterImagePainter(imageUrl) {
...
CharacterRunSpriteSheetPainter = function CharacterRunSpriteSheetPainter(cells, spritesheeturl, mycanvas, imgcount) {
...
CharacterRiseSpriteSheetPainter = function CharacterRiseSpriteSheetPainter(cells, spritesheeturl, mycanvas, imgcount) {
    SpriteSheetPainter.call(this, cells, spritesheeturl, mycanvas);
    this.imgcount = imgcount;
};
...
//场景Sprite
var SceneSprite = function SceneSprite(name, painter, behaviors) {
...
var SceneImagePainter = function SceneImagePainter(imageUrl) {
    ImagePainter.call(this, imageUrl);
};
SceneImagePainter.prototype = {
    ...
    //马里奥对象
};var Mario = function Mario(setting) {
...
//怪兽对象
var Monster = function Monster(setting) {
    Sprite.call(this, setting.name);
    this.isDie = false;
...
//乌龟对象
var Tortoise = function Tortoise(setting) {
    Sprite.call(this, setting.name);
    this.isDie = false;
    this.isReverse = true;
    this.id = lib.newGuid(), this.mycanvas = element.mycanvas;
    this.name = 'tortoise';
    this.translateLeft = 0;
    //this.velocityX = setting.velocityX;
...
//怪兽对象
var Shell = function Shell(setting) {
    Sprite.call(this, setting.name);
    this.isDie = false;
    this.isReverse = true;
    this.id = lib.newGuid(), this.mycanvas = element.mycanvas;
...
var Life = function Life(setting) {
...
var Over = function Over(setting) {
...
var Wall = function Wall(setting) {
    var self = this;
...
//金币对象
var Money = function Money(setting) {
...
//flower
var Flower = function Flower(setting) {
...
//flower
var BadFlower = function BadFlower(setting) {
...
//蘑菇
var Mushroom = function Mushroom(setting) {
    var self = this;
...
//小星星
var Star = function Star(setting) {
...
//子弹
var Bullet = function Bullet(setting) {
...
//管道对象
var Pipe = function Pipe(setting) {
...
//旗杆对象
var Final = function Final(setting) {
...
//旗帜对象
var Flag = function Flag(setting) {
...
//城堡对象
var Tower = function Tower(setting) {
...
//洞对象
var Hole = function Hole(setting) {
...
var Brick = function Brick(setting) {
