...
let CharacterRunSpriteSheetPainter = function(cells, spritesheeturl, mycanvas, imgcount) {
...
let CharacterRiseSpriteSheetPainter = function(cells, spritesheeturl, mycanvas, imgcount) {
    SpriteSheetPainter.call(this, cells, spritesheeturl, mycanvas);
    this.imgcount = imgcount;
}
